...
const BOOT = [
  ...
  { t: '',                                                                    d: 50  },
  { t: 'ping -c 3 Mr74nX',                                               d: 260, cmd: true },
  { t: 'PING Mr74nX: 56 data bytes',                                     d: 40  },
  { t: '64 bytes from Mr74nX: icmp_seq=0 ttl=64 time=0.412 ms',         d: 55  },
  { t: '64 bytes from Mr74nX: icmp_seq=1 ttl=64 time=0.387 ms',         d: 55  },
  { t: '64 bytes from Mr74nX: icmp_seq=2 ttl=64 time=0.401 ms',         d: 55  },
  { t: '<span class="tg">3 packets transmitted, 3 received, 0% packet loss</span>', d: 40 },
  { t: '',                                                                    d: 50  },
  { t: 'echo $STATUS',                                                       d: 240, cmd: true },
  { t: '<span class="tg">available_for_collaboration</span>',                d: 40  },
  { t: '',                                                                    d: 40  },
  { t: '<span class="tl">type </span><span class="tw">help</span><span class="tl"> for available commands</span>', d: 0 },
  { t: '',                                                                    d: 0   },
];
