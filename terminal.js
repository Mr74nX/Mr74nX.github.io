...
const BOOT = [
  ...
  { t: '',                                                                    d: 50  },
  { t: 'ping -c 3 mrtan.dev',                                               d: 260, cmd: true },
  { t: 'PING mrtan.dev: 56 data bytes',                                     d: 40  },
  { t: '64 bytes from mrtan.dev: icmp_seq=0 ttl=64 time=0.412 ms',         d: 55  },
  { t: '64 bytes from mrtan.dev: icmp_seq=1 ttl=64 time=0.387 ms',         d: 55  },
  { t: '64 bytes from mrtan.dev: icmp_seq=2 ttl=64 time=0.401 ms',         d: 55  },
